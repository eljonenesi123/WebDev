...
export const translations = {
  en: {
    ...
    "work.title": "Work",
    "work.sub": "Six projects, shown the way they actually run. Swipe or tap through — design, code, and deployment, end to end.",
  ...
  sq: {
    ...
    "work.title": "Punimet",
    "work.sub": "Gjashtë projekte, ashtu siç funksionojnë në të vërtetë. Rrëshqit ose prek për t'i shfletuar — dizajn, kod, dhe deployment, nga fillimi në fund.",
  ...
  de: {
    ...
    "work.title": "Projekte",
    "work.sub": "Sechs Projekte, gezeigt so, wie sie wirklich laufen. Wische oder tippe dich durch — Design, Code und Deployment, von Anfang bis Ende.",
