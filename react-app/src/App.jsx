      ...
      <div className="contact-split">
        <div className="contact-info">
          ...
          <div className="contact-socials">
            ...
            <a href="https://www.linkedin.com/company/script-line-studio/" target="_blank" rel="noopener" className="social-link" aria-label="LinkedIn" onClick={socialClick("LinkedIn")}>
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM2.5 9.75h5v11h-5zM9.5 9.75h4.79v1.5h.07c.67-1.2 2.3-2.47 4.73-2.47 5.06 0 6 3.33 6 7.66v6.31h-5v-5.6c0-1.34-.02-3.06-1.87-3.06-1.87 0-2.16 1.46-2.16 2.96v5.7h-5z" /></svg>
            </a>
      ...
      <div className="footer-top">
        <div className="footer-col footer-brand-col">
          ...
          <div className="footer-socials">
            ...
            <a href="https://www.linkedin.com/company/script-line-studio/" target="_blank" rel="noopener" aria-label="LinkedIn"><svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM2.5 9.75h5v11h-5zM9.5 9.75h4.79v1.5h.07c.67-1.2 2.3-2.47 4.73-2.47 5.06 0 6 3.33 6 7.66v6.31h-5v-5.6c0-1.34-.02-3.06-1.87-3.06-1.87 0-2.16 1.46-2.16 2.96v5.7h-5z" /></svg></a>
