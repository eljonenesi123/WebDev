...
const translations = {
  en: {
    ...
    "services.note": "Final price depends on number of pages, custom features, and content — I'll give you an exact quote before any work starts.",
  ...
  sq: {
    ...
    "services.note": "Çmimi final varet nga numri i faqeve, funksionalitetet e personalizuara, dhe përmbajtja — do t'ju jap një ofertë të saktë para se të fillojë puna.",
  ...
  de: {
    ...
    "services.note": "Der endgültige Preis hängt von der Seitenzahl, individuellen Funktionen, und den Inhalten ab — du bekommst ein genaues Angebot, bevor die Arbeit beginnt.",
